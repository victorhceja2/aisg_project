        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-gradient-to-r from-[#0033A0] to-[#00B140] p-4 sm:p-6 rounded-t-xl shadow-lg">
            <div className="flex flex-col items-center justify-center text-white">
              ...
              <p className="text-sm sm:text-base text-gray-200 mt-1 font-light">Aeronautical Services Management System</p>
            </div>
          </div>

          <div className="bg-[#16213E] p-4 sm:p-8 rounded-b-xl shadow-lg border-l border-r border-b border-[#0033A0]/20">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 text-center">Sign In</h2>
