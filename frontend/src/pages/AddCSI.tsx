...
const AddCSI: React.FC = () => {
  ...
  // Obtener el nombre de usuario de la sesión al cargar el componente
  useEffect(() => {
  }, []);

  /**
   * Verifica si un servicio include con el mismo nombre ya existe
   */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Error adding service include:", err);
          ...
          <div className="overflow-hidden max-w-md w-full mx-4 rounded-lg shadow-xl">
            ...
            <div className="bg-[#1E2A45] rounded-b-lg shadow-lg px-8 py-8">
              <div className="flex items-center mb-4 justify-center">
                ...
                <p className="text-white text-lg">Service include has been successfully added!</p>
              </div>
