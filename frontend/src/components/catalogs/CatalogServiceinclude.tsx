...
/**
 * Catalog for Service Includes. Allows search, add, edit, and delete.
 */
const CatalogServiceInclude: React.FC = () => {
    ...
    // Fetch service includes from backend
        ...
        <div className="min-h-screen bg-[#1A1A2E] p-6 font-['Montserrat']">
            <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-to-r from-[#0033A0] to-[#00B140] p-6 rounded-t-lg shadow-lg">
                    <h1 className="text-3xl font-bold text-white text-center">Service Include Catalog</h1>
                    <p className="text-gray-200 mt-2 font-light text-center">Manage the different service include types</p>
                </div>
                            ...
                            <table className="w-full table-auto">
                                ...
                                <tbody className="divide-y divide-[#1E2A45]">
                                    {includes.length === 0 ? (
                                        ...
                                        includes.map((inc) => (
                                            <tr key={inc.id_service_include} className="hover:bg-[#1E2A45] transition-colors">
                                                <td className="px-6 py-4 text-gray-300">{inc.id_service_include}</td>
                                                <td className="px-6 py-4 text-white font-medium">{inc.service_include}</td>
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex justify-center space-x-2">
                                                        ...
                                                        <button
                                                            onClick={() => handleDelete(inc.id_service_include, inc.service_include)}
