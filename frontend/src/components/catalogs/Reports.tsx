/**
 * Selector de reportes para AISG.
 * Permite al usuario navegar a los distintos reportes disponibles (operaciones, servicios, etc).
 * Muestra tarjetas con íconos, nombre y estado (activo o en desarrollo).
 */
        ...
        <AISGBackground>
            <div className="max-w-7xl mx-auto p-6 font-['Montserrat']">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-200 mt-2 font-light">Reporting and analysis system</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        {reports.map(({ label, path, icon, disabled }) => (
                            <div
                                ...
                                className={`bg-[#16213E] rounded-xl shadow-xl overflow-hidden cursor-pointer hover:shadow-2xl transition-shadow border border-[#0033A0] flex flex-col items-center ${disabled ? "opacity-60 cursor-not-allowed" : "hover:border-[#00B140]"}`}
