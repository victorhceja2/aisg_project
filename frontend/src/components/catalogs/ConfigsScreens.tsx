/**
 * Selector visual de catálogos de configuración para AISG.
 * Cada card permite navegar a la sección de gestión de un catálogo específico.
 * Mantiene un diseño consistente y centralizado para la administración de catálogos.
 */
