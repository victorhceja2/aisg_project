...
const OperationReport: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1A1A2E] py-8 px-4 font-['Montserrat'] text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-[#16213E] rounded-lg shadow-lg overflow-x-auto">
          <table className="min-w-full table-auto text-xs">
            ...
            <tbody>
              {/* Aquí van los datos, ejemplo de fila */}
              <tr className="border-b border-[#233554] hover:bg-[#1E2A45]">
